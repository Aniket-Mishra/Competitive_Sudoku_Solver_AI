...
from A2_Heuristics_Jelle.helper_functions import simulate_move, get_valid_moves
from A2_Heuristics_Jelle.minimax import minimax
from A2_Heuristics_Jelle.taboo_helpers import naked_singles, hidden_singles
import time
