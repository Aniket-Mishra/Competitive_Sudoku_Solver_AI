...
from A3_MCTS_with_minimax.helper_functions import simulate_move, get_valid_moves
...
def minimax(game_state: GameState,depth: int,alpha: int,beta: int,maximizing: bool,ai_player_index: int,) -> float:
    ...
    if maximizing:
        ...
        for move in valid_moves:
            ...
            eval = minimax(next_state,depth - 1,alpha,beta,maximizing=False,ai_player_index=ai_player_index,)
        ...
        for move in valid_moves:
            next_state = simulate_move(game_state, move)
            eval = minimax(next_state,depth - 1,alpha,beta,maximizing=True,ai_player_index=ai_player_index,)
